...
<head>
	<!-- Page title -->
	<title>Search Form - Lavinia Paris Part C</title>
	<meta charset="utf-8">
...
<a href="form4.php">
			...
			<form action="searchwinepc.php" method="get">
				<table style="width:100%;">
					...
					<tr>
						<th>PRICE RANGE</th>
						<td>Lowest: ($)<input type="text" name="minPrice" size="10">&nbsp;&nbsp; to &nbsp;&nbsp  Highest ($) <input type="text" name="maxPrice" size="10"></td>
					</tr>
				</table>
				<!-- Search button -->
